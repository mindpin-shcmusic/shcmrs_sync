...
// ported for mindpin.com by ben7th
// version 0.1
...
var TextboxList = new Class({
  ...
  initialize: function(element, options){
    ...
    // this.container = new Element('div', {'class': this.options.prefix}).i_nject(element, 'after');
    ...
    // this.list = new Element('ul', {'class': this.options.prefix + '-bits'}).i_nject(this.container);   
  ...
  //   // if (this.options.endEditableBit) this.create('editable', null, {tabIndex: this.original.tabIndex}).injject(this.list);
...
var TextboxListBit = new Class({
  ...
  inject: function(element, where){
    this.bit.i_nject(element, where);  
...
TextboxListBit.Editable = new Class({
  ...
  initialize: function(value, textboxlist, options){
    ...
    this.element = new Element('input', {type: 'text', 'class': this.typeprefix + '-input', autocomplete: 'off', value: this.value ? this.value[1] : ''}).i_nject(this.bit);   
...
TextboxListBit.Box = new Class({
  ...
  initialize: function(value, textboxlist, options){
    ...
    if (this.options.deleteButton){
      ...
      this.close = new Element('a', {href: '#', 'class': this.typeprefix + '-deletebutton', events: {click: this.remove.bind(this)}}).i_nject(this.bit);
    }
