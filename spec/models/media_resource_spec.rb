  ...
  describe '资源操作' do
    ...
    before do
      MediaResource.create(
        ...
        :media_resources => [
          MediaResource.create(
            ...
            :is_dir => true,
            :media_resources => [
              MediaResource.create(:name => '兔斯基.jpg.gif', :is_dir => false),
              MediaResource.create(:name => '狗头.jpg', :is_dir => false)
            ]
          )
        ]
      )
      ...
      MediaResource.create(
        ...
        :is_dir => true,
        :media_resources => [
          MediaResource.create(:name => '三只熊猫.jpg', :is_dir => false),
          MediaResource.create(:name => '倒挂.jpg', :is_dir => false),
          MediaResource.create(:name => '这是寂寞.jpg', :is_dir => false)
        ]
      )
    ...
    describe '创建文件夹资源' do
      it '当指定位置已经存在任何资源时，抛出异常' do
        MediaResource.get('/太极图.jpg').is_file?.should == true
        MediaResource.get('/大熊猫').is_dir?.should == true
